module.exports = {
  someSidebar: {
    ...
    SDK: ['books/authentication', 'books/authenticationv2', 'books/account', 'books/contact', 'books/product', 'books/taxes', 'books/invoice', 'books/order', 'books/salesorder', 'books/payment', 'books/warehouse', 'books/stock', 'books/fulfillment', 'books/shipment', 'books/reports', 'books/journal'],
    Resources: ['books/authenticationapi', 'books/accountapi', 'books/contactapi', 'books/productapi', 'books/taxesapi', 'books/orderapi', 'books/billapi', 'books/quotationapi', 'books/invoiceapi', 'books/makepaymentapi', 'books/expenseapi', 'books/receivepaymentapi', 'books/depositapi','books/noteapi','books/iamapi','books/inventoryapi', 'books/webhook','books/customfieldapi', 'books/mrpapi', 'books/tenantapi', 'books/subscriptionapi', 'books/returnsapi', 'books/reportsapi']
  },
