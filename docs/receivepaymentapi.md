...
```java
curl -X POST "https://bifrost.deskera.com/v1/payments/receive" -H "accept: application/json" -H "x-access-token: sampleaccesstoken" -H "Content-Type: application/json" -d "{ \"documentDate\": \"2020-06-18\", \"closeDate\": \"2020-06-18\", \"amount\": 128.4, \"currency\": \"SGD\", \"exchangeRate\": 1, \"contactCode\": \"C-0000001\", \"accountCodePayTo\": \"AC-0000002\", \"receivePaymentItemDtoList\": [ { \"documentCode\": \"0000002\", \"documentType\": \"SALES_INVOICE\", \"exchangeRate\": 1, \"paymentAmount\": 128.4 } ], \"paymentType\": \"CASH\"}"
```
##### Parameters
...
```java
{
  ...
  "accountCodePayTo": "AC-0000002",
  "receivePaymentItemDtoList": [
    {
      "documentCode": "0000002",
